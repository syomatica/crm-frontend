var sottoCategoria = sessionStorage.getItem('sottoCategoria');
var descrizione = sessionStorage.getItem('descrizione');
var idScategoria = sessionStorage.getItem('idScategoria');
var magoTipoArt = sessionStorage.getItem('magoTipoArts');
...
$( document ).ready(function() {
    ...
    $('#pulisci').on('click', function() {
        $("#sottoCategoria, #descrizione, #nota").val(null);
